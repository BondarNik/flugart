...
import fcatBoardImage from "@/assets/instructions/taipan-15-fcat-board.jpg";
import motorsImage from "@/assets/instructions/taipan-15-motors.jpg";

const InstructionsTaipan15 = () => {
  const { language } = useLanguage();

  const content = {
    uk: {
      backButton: "Назад",
      pageTitle: "Інструкція ТАЙПАН 15\"",
      intro: "Коротка загальна інструкція до FPV системи 15 дюймів на радіо керуванні.",
      ...
      flightRangeValue: "до 25 км",
      operationalRange: "Оперативна дальність:",
      operationalRangeValue: "до 15 км",
      ...
      chargingCurrent: "Струм заряджання:",
      chargingCurrentValue: "8s3p до 5А, 8s6p до 7А",
      maxLoadNote: "Максимальне навантаження на дрон що протестовано: 8 кг вантажу на 13 км за умови АКБ 8s6p 30 000 mAh.",
    ...
    en: {
      backButton: "Back",
      pageTitle: "TAIPAN 15\" Instructions",
      intro: "Brief general instructions for the 15-inch FPV radio-controlled system.",
      ...
      flightRangeValue: "up to 25 km",
      operationalRange: "Operational range:",
      operationalRangeValue: "up to 15 km",
      ...
      chargingCurrentValue: "8s3p up to 5A, 8s6p up to 7A",
      maxLoadNote: "Maximum tested load: 8 kg payload over 13 km with 8s6p 30,000 mAh battery.",
...
export default InstructionsTaipan15;
