...
import fcatBoardImage from "@/assets/instructions/taipan-10-fcat-board.jpg";
import motorsImage from "@/assets/instructions/taipan-10-motors.jpg";

const InstructionsTaipan10 = () => {
  const { language } = useLanguage();

  const content = {
    uk: {
      backButton: "Назад",
      pageTitle: "Інструкція ТАЙПАН 10\"",
      intro: "Коротка загальна інструкція до FPV системи 10 дюймів на радіо керуванні.",
      
      // Section 1
      section1Title: "1. Основні загальні характеристики дрона",
      maxPayload: "Максимальне корисне навантаження:",
      maxPayloadValue: "до 2 кг",
      flightRange: "Дальність польоту з корисним вантажем:",
      flightRangeValue: "до 16 км",
      flightTime: "Час польоту з максимально корисним вантажем:",
      flightTimeValue: "до 18 хв",
      ...
      windLoadValue: "до 10 м/сек",
      recommendedBattery: "Рекомендований АКБ:",
      recommendedBatteryValue: "15 000 mAh 6s3p",
      propeller: "Пропеллер:",
      propellerValue: "10х7х3",
      ...
      chargingCurrent: "АКБ 6s3p слід заряджати струмом:",
      chargingCurrentValue: "3А",
      ...
      recommendation4: "Плати обладнані системами запобіжників що захищають від випадкових увімкнених тумблерів на пульті під час подачі живлення, захист від невірно припаяних дротів, захист вмикається навіть коли невірно налаштований AUX, а плата підʼєднана до польотного контроллера.",
    ...
    en: {
      backButton: "Back",
      pageTitle: "TAIPAN 10\" Instructions",
      intro: "Brief general instructions for the 10-inch FPV radio-controlled system.",
      
      // Section 1
      section1Title: "1. Main Drone Specifications",
      maxPayload: "Maximum payload:",
      maxPayloadValue: "up to 2 kg",
      flightRange: "Flight range with payload:",
      flightRangeValue: "up to 16 km",
      flightTime: "Flight time with maximum payload:",
      flightTimeValue: "up to 18 min",
      ...
      windLoadValue: "up to 10 m/s",
      recommendedBattery: "Recommended battery:",
      recommendedBatteryValue: "15,000 mAh 6s3p",
      propeller: "Propeller:",
      propellerValue: "10x7x3",
      ...
      chargingCurrent: "6s3p battery should be charged at:",
      chargingCurrentValue: "3A",
      ...
      recommendation4: "The boards are equipped with safety systems that protect against accidentally activated switches on the remote during power-up, protection against incorrectly soldered wires, protection activates even when AUX is incorrectly configured while the board is connected to the flight controller.",
      ...
      <main className="relative z-10 container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="bg-gradient-to-r from-cyan-500/20 to-teal-500/20 border border-cyan-500/30 rounded-2xl p-8 text-center">
          <p className="text-xl text-cyan-300 font-medium">
            {language === 'uk' ? 'Вдалого польоту!' : 'Happy flying!'}
          </p>
        </div>
      </main>
...
export default InstructionsTaipan10;