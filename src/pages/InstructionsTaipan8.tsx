...
import fcatBoardImage from "@/assets/instructions/taipan-8-fcat-board.jpg";
import motorsImage from "@/assets/instructions/taipan-8-motors.jpg";

const InstructionsTaipan8 = () => {
  const { language } = useLanguage();

  const content = {
    uk: {
      backButton: "Назад",
      pageTitle: "Інструкція ТАЙПАН 8\"",
      intro: "Коротка загальна інструкція до FPV системи 8 дюймів на радіо керуванні.",
      
      // Section 1
      section1Title: "1. Основні загальні характеристики дрона",
      maxPayload: "Максимальне корисне навантаження:",
      maxPayloadValue: "1.5 кг",
      flightRange: "Дальність польоту з корисним вантажем:",
      flightRangeValue: "до 15 км",
      flightTime: "Час польоту з максимально корисним вантажем:",
      flightTimeValue: "13 хв",
      maxAltitude: "Максимальна висота польоту:",
      maxAltitudeValue: "до 1000 м",
      cruiseSpeed: "Крейсерська швидкість руху:",
      cruiseSpeedValue: "60 км/год",
...
export default InstructionsTaipan8;